...
execute_process(
  COMMAND "/usr/bin/git" show-ref "18c72431f8265e2b0b5378a3a73d8a883b2175ff"
  WORKING_DIRECTORY "/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/implot-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/implot-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/implot-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
