...
execute_process(
  COMMAND "/usr/bin/git" show-ref "11b3a7c8ca23201294464c7f368614a9106af2a1"
  WORKING_DIRECTORY "/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/imgui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/imgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/imgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
