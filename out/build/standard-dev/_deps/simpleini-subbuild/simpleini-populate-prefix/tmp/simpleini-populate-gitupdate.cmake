...
execute_process(
  COMMAND "/usr/bin/git" show-ref "09c21bda1dc1b578fa55f4a005d79b0afd481296"
  WORKING_DIRECTORY "/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/simpleini-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/simpleini-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/simpleini-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
