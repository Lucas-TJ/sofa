...
execute_process(
  COMMAND "/usr/bin/git" show-ref "bf610efb2e5d4361df799d0dfb5ae3977d7bba2e"
  WORKING_DIRECTORY "/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/iconfontcppheaders-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/iconfontcppheaders-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lucasbureltojo/sofa3/src/out/build/standard-dev/_deps/iconfontcppheaders-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
