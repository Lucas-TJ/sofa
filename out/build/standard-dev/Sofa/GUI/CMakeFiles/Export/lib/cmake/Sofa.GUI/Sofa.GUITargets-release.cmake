...
set_target_properties(Sofa.GUI PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofa.GUI.so.25.06.99"
  IMPORTED_SONAME_RELEASE "libSofa.GUI.so.25.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS Sofa.GUI )
list(APPEND _IMPORT_CHECK_FILES_FOR_Sofa.GUI "${_IMPORT_PREFIX}/lib/libSofa.GUI.so.25.06.99" )
...
set_target_properties(runSofa PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/runSofa-25.06.99"
  )

list(APPEND _IMPORT_CHECK_TARGETS runSofa )
list(APPEND _IMPORT_CHECK_FILES_FOR_runSofa "${_IMPORT_PREFIX}/bin/runSofa-25.06.99" )
