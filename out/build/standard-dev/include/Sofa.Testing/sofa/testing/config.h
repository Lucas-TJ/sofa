...
#define SOFA_TESTING_VERSION 25.06.99

//constexpr std::string with C++20 only
constexpr char SOFA_TESTING_RESOURCES_DIR[] = "/home/lucasbureltojo/sofa3/src/Sofa/framework/Testing/resources";
...
#ifdef SOFA_BUILD_SOFA_TESTING
#define SOFA_ATTRIBUTE_DISABLED__TESTING_IMPORT_PLUGIN()
#else
#define SOFA_ATTRIBUTE_DISABLED__TESTING_IMPORT_PLUGIN() \
...
#ifdef SOFA_BUILD_SOFA_TESTING
#define SOFA_ATTRIBUTE_DEPRECATED__TESTING_ONSETUP()
#else
#define SOFA_ATTRIBUTE_DEPRECATED__TESTING_ONSETUP() \
...
#ifdef SOFA_BUILD_SOFA_TESTING
#define SOFA_ATTRIBUTE_DEPRECATED__TESTING_ONTEARDOWN()
#else
#define SOFA_ATTRIBUTE_DEPRECATED__TESTING_ONTEARDOWN() \
    SOFA_ATTRIBUTE_DEPRECATED( \
